...
bool unique_chars(std::string &inp) {
 ...
 */
std::string &remove_dups(std::string &str) {
 ...
 */
bool anagrams(std::string &inp1, std::string &inp2) {
 ...
 */
std::string &replace_spaces(std::string &inp) {
...
void row_col_zero(matrix &in_matrix) {
...
bool sub_str(std::string &str1, std::string &str2) {
